...
public class StandardContext implements Context, Pipeline, Lifecycle {
     ...
     * value: FilterDef对象
     */
    private Map<String, SimpleFilterDef> filterMaps = new HashMap<>();
    ...
    /**
     * 根据servletName返回对应的FilterDef对象
     * @param filterName
     * @return
     */
    public SimpleFilterDef getFilterDef(String filterName){
        return this.filterMaps.get(filterName);
    }
     ...
     */
    @Override
    public void addFilterDef(SimpleFilterDef filterDef) {
        this.filterMaps.put(filterDef.getFilterName(), filterDef);
    }

    public Map<String, SimpleFilterDef> getFilterMaps() {
        return filterMaps;
    }
