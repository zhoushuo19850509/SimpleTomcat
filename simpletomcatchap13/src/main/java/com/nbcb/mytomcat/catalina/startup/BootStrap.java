...
import com.nbcb.mytomcat.catalina.filter.SimpleFilterDef;
...
public class BootStrap {
    ...
    public static void main(String[] args){
        ...
        /**
         * 添加filter信息到context
         * 后续把filter信息放到配置文件，并由专门的组件读取放到context
         */
        SimpleFilterDef filterDef1 = new SimpleFilterDef();
        filterDef1.setFilterName("CorsFilter");
        filterDef1.setFilterClass("com.nbcb.mytomcat.catalina.filter.filters.CorsFilter");

        SimpleFilterDef filterDef2 = new SimpleFilterDef();
        filterDef2.setFilterName("RemoteHostFilter");
        filterDef2.setFilterClass("com.nbcb.mytomcat.catalina.filter.filters.RemoteHostFilter");

        SimpleFilterDef filterDef3 = new SimpleFilterDef();
        filterDef3.setFilterName("RemoteIpFilter");
        filterDef3.setFilterClass("com.nbcb.mytomcat.catalina.filter.filters.RemoteIpFilter");

        context.addFilterDef(filterDef1);
        context.addFilterDef(filterDef2);
        context.addFilterDef(filterDef3);
