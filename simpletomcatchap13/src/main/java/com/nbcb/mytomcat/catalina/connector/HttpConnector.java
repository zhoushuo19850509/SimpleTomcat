...
//                " current Proccessor is : " + currProccessors);
     ...
     *
     * @待优化
     * 1.生成ServerSocket的过程，交给factory来做(org.org.apache.catalina.net.ServerSocketFactory)
     *
...
//        System.out.println("a new thread(HttpProcessor) is created! thread info: " + processor.hashCode() );
    ...
    public Request createRequest() {
        ...
        /**
         * 这里需要制定request对象所属哪个context
         * 因为后续我们在servlet中调用request.getSession()方法的时候，
         * 需要由context来指定session manager
         */
        request.setContext((Context) this.container);
        return request;
    }
