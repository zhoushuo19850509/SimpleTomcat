...
20210716
又是差不多有一个月没有参与到工程中来，其中有2星期左右身体不适。
之前还有一次因为网络不通，导致集群间组播通信阻断。

自己亲自参与过一项工作，才知道有多艰难。
感叹人生苦短。必须抓紧时间，做一些有意义的事情。少在无意义的事情上浪费时间精力。

因为UDP存在的种种问题，我们后续计划把UDP组播方式，改为TCP点对点的方式。

20210726
但是这次没有调通，也不是UDP的问题，而是没有一鼓作气，把集群功能拿下。
一方面是因为集群功能相对来说测试比较麻烦，有时候没有网络，就没法访问组播地址。
一方面是打包的问题，这次是第一次把tomcat打包成jar包执行，还是花费了不少时间；
当然最重要的原因还是没有找到大片的连续时间，一次性把问题搞定。
这次暴露的问题，还是对java生态了解不够深入，在分布式集群实现、maven功能等方面还是基础不够。


20210801
今天是周末，今天梳理了一个主题：
servlet名称和servlet类如何映射.docx
感觉收获还是很大的。因为这个主题我们之前反复回顾了好多遍。
