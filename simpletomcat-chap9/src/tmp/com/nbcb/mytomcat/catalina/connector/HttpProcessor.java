...
import com.nbcb.mytomcat.catalina.util.RequestUtil;
...
//                System.out.println("HttpProcessor finish invoke the Servlet: " + this.hashCode());
    ...
    public void parseHeaders(SocketInputStream input){
        ...
        for(Map.Entry<String, String> entry : headers.entrySet()){
             ...
             * 处理一些特殊的Http header
             */
            if(name.equals(Constants.COOKIE_NAME)){   // 处理来自客户端的cookie信息
                ...
                for(int i = 0 ; i < cookies.length; i++){
                    if(cookies[i].getName().trim().equals(Constants.JSESSION_ID)){
